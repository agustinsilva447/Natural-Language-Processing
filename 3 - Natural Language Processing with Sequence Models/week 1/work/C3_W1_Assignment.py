...
### START CODE HERE (Replace instances of 'None' with your code) ###
        ...
        example_weights = np.ones_like(np.arange(batch_size, dtype=float))
...
def compute_accuracy(preds, y, y_weights):
    ...
    correct_float = is_pos.astype(np.float32)
    ...
    # denominator.
    weighted_num_correct =  sum(weighted_correct_float)*2.0    
...
def test_model(generator, model):
    ...
    accuracy =  total_num_pred / total_num_correct 
