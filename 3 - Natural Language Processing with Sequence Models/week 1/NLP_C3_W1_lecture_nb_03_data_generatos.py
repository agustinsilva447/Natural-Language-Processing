...
def data_generator(batch_size, data_x, data_y, shuffle=True):
    ...
    while True:
        X = [0] * batch_size #list(range(batch_size)) # We can create a list with batch_size elements. 
        Y = [0] * batch_size #list(range(batch_size)) # We can create a list with batch_size elements. 
